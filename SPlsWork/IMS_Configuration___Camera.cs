...
namespace UserModule_IMS_CONFIGURATION___CAMERA
{
    public class UserModuleClass_IMS_CONFIGURATION___CAMERA : SplusObject
    {
        ...
        Crestron.Logos.SplusObjects.AnalogOutput CAMERA_SWITCHER_VALUE;
                            ...
                            try 
                                ...
                                try 
                                    ...
                                    public override void LogosSplusInitialize()
                                    {
                                        ...
                                        CAMERA_SWITCHER_VALUE = new Crestron.Logos.SplusObjects.AnalogOutput( CAMERA_SWITCHER_VALUE__AnalogSerialOutput__, this );
                                        m_AnalogOutputList.Add( CAMERA_SWITCHER_VALUE__AnalogSerialOutput__, CAMERA_SWITCHER_VALUE );
                                    ...
                                    const uint CAMERA_SWITCHER_VALUE__AnalogSerialOutput__ = 0;
                                    const uint CAMERA_PRESET1_ID__AnalogSerialOutput__ = 1;
                                    const uint CAMERA_PRESET1_NAME__AnalogSerialOutput__ = 2;
                                    const uint CAMERA_PRESET2_ID__AnalogSerialOutput__ = 3;
                                    const uint CAMERA_PRESET2_NAME__AnalogSerialOutput__ = 4;
                                    const uint CAMERA_PRESET3_ID__AnalogSerialOutput__ = 5;
                                    const uint CAMERA_PRESET3_NAME__AnalogSerialOutput__ = 6;
                                    const uint CAMERA_PRESET4_ID__AnalogSerialOutput__ = 7;
                                    const uint CAMERA_PRESET4_NAME__AnalogSerialOutput__ = 8;
                                    const uint CAMERA_PRESET5_ID__AnalogSerialOutput__ = 9;
                                    const uint CAMERA_PRESET5_NAME__AnalogSerialOutput__ = 10;
                                    const uint CAMERA_PRESET6_ID__AnalogSerialOutput__ = 11;
                                    const uint CAMERA_PRESET6_NAME__AnalogSerialOutput__ = 12;
                                    const uint CAMERA_SSI_SEVERITY_MESSAGE__AnalogSerialOutput__ = 13;
                                    const uint CAMERA_SSI_ERROR_TEXT__AnalogSerialOutput__ = 14;
                                    const uint CAMERA_SSI_OK_TEXT__AnalogSerialOutput__ = 15;
